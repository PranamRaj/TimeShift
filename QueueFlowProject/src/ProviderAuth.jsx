...
export default function ProviderAuth({ onAuthSuccess }) {
    ...
    return (
        <div
            style={{
                ...
                boxShadow: "0 8px 26px rgba(220,38,38,0.12)",
                padding: "22px 20px",
            }}
        >
            <p
            ...
            >
                {isSignUp ? "Have an account? Sign In" : "New provider? Create account"}
            </button>
        </div>
    );
}
